...
<div>
    ...
    <button type="button" data-modal-target="add-data-modal" data-modal-show="add-data-modal" class="text-white bg-cyan-600 hover:bg-cyan-700 font-medium rounded-lg text-sm mb-6 px-5 py-2.5 mr-2 mb-2">Tambah</button>
</div>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b">
                ...
                <td class="px-6 py-4 flex space-x-2">
                    <button data-modal-target="add-data-modal" title="Edit" onclick="hideButton()" data-modal-show="add-data-modal">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6 text-cyan-500">
...
<form class="pt-6 w-2/5">
    <div class="flex flex-row items-center justify-items-start pb-2">
        ...
        <input type="text" value="200000" id="small-input" class="total basis-2/5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full p-2.5 mr-2" disabled>
    ...
    <div class="flex flex-row items-center justify-items-start pb-2">
        ...
        <input type="number" value="100" id="small-input" class="dibayarkan basis-2/5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full p-2.5 mr-2">
        <div class="basis-1/5">
    ...
    <div class="flex flex-row items-center justify-items-start pb-2">
        ...
        <input type="text" id="small-input" class="sisa basis-2/5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full p-2.5 mr-2" disabled>
        <div class="basis-1/5">
...
<!-- Add data modal -->
<div id="add-data-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow">
            <button type="button " class="absolute tutup top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="add-data-modal">
                    ...
                    <div id="input-box">
                        <div id="input-data" class="flex flex-row pb-4">
                            <div class="basis-1/2 relative pr-2">
                                <input wire:model.defer="person" type="text" id="nama" name="nama" list="person" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-cyan-600 peer" placeholder=" " />
                            ...
                            <div class="relative basis-1/4 pr-2">
                                <input type="text" id="kredit" name="kredit" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-cyan-600 peer" placeholder=" " />
...
{{-- Confirmation modal --}}
<div id="confirmation-modal" tabindex="-1" data-modal-backdrop="static" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            <div class="p-6 text-center">
                ...
                <button data-modal-hide="confirmation-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Lanjut
                </button>
                <button data-modal-hide="confirmation-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">
                    Batal</button>
            </div>
        </div>
    </div>
