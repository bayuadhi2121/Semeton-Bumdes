    ...
    <div class="flex flex-row">
        <div class="basis-1/2 p-4 bg-neutral-100 rounded-lg m-2">
            ...
            <div class="flex items-center mb-2 ">
                <input id="default-radio-1" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 mr-2">
                <label for="default-radio-1" class="ml-2 text-base font-medium text-gray-900 ">Laporan Neraca</label>
            </div>
            
            <h3 class="ml-6 pl-2 text-base font-medium text-gray-900 mb-2">Laporan Laba Rugi</h3>
            <div class="ml-6 pl-2">
                <div class="flex items-center mb-2">
                    <input id="default-radio-2" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 mr-2">
                    <label for="default-radio-2" class="ml-2 text-base font-medium text-gray-900 ">Jasa</label>
                </div>
                <div class="flex items-center mb-2">
                    <input id="default-radio-3" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 mr-2">
                    <label for="default-radio-3" class="ml-2 text-base font-medium text-gray-900 ">Dagang</label>
                </div>
                <div class="flex items-center mb-2">
                    <input id="default-radio-4" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 mr-2">
                    <label for="default-radio-4" class="ml-2 text-base font-medium text-gray-900 ">Gabungan</label>
                </div>
            </div>
            <div class="flex items-center mb-2">
                <input id="default-radio-5" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 mr-2">
                <label for="default-radio-5" class="ml-2 text-base font-medium text-gray-900 ">Laporan Perubahan Modal</label>
            </div>
