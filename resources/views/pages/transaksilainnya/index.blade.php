    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900">Transaksi Lainnya</h3>
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-autohide type="text"
                            class="bg-gray-50 border border-gray-300 bg-transparent bg-cyan-700 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 "
                            placeholder="Tanggal">
                    </div>
                    ...
                    <div class="relative ">
                        ...
                        {{-- <label class="block mb-2 text-sm font-medium text-gray-900 " for="file_input">Upload
                            file</label> --}}
                        <input
                            class="block w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-transparent bg-cyan-700"
