            ...
            <tbody>
                ...
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4 flex space-x-2">
                        <button wire:click="setData('{{ $item->id_person }}','')" onclick="setModal('Edit')"
                        ...
                        <button wire:click="from('{{ $item->id_person }}','reset')"
                        ...
                        <button wire:click="from('{{ $item->id_person }}','delete')"
                            data-modal-target="confirmation-modal" data-modal-show="confirmation-modal">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            ...
                            <ul
                                ...
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r">
                                    <div class="flex items-center pl-3">
                                        <input wire:model.defer="status" id="bendahara" type="radio" value="Bendahara"
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow">
                <div class="p-6 text-center">
                    ...
                    <button wire:click='action' data-modal-hide="confirmation-modal" type="button"
