<div>
    <h2 class="text-2xl font-medium mb-5 pb-1 flex flex-inline border-b-4 border-cyan-500">Data Jenis Pendapatan
    </h2>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                @livewire('JenisPendapatan.item', ['number' => $jenispendapatan->firstItem() + $loop->index,
                'jenispendapatan' => $item], key(null))
                @empty
                <tr>
    ...
    <!-- Add data modal -->
    @livewire('JenisPendapatan.add-edit-modal')

    {{-- Confirmation modal --}}
    @livewire('JenisPendapatan.delete-modal')
</div>