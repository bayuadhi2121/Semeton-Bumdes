<div>
    <div>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    ...
                    @livewire('j-pendapatan.item-table', ['number' => $jenispendapatan->firstItem() + $loop->index,
                    'jenispendapatan'=> $item],
                    key($item->id))
                    @empty
                    <tr>
        ...
        <!-- Add data modal -->
        @livewire('j-pendapatan.add-edit-modal')

        {{-- Confirmation modal --}}
        @livewire('j-pendapatan.delete-modal')
