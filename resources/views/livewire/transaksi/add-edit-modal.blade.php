            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form wire:submit.prevent="{{ $mode }}" class="space-y-6">
                        <div>
                            <input wire:model="tanggal" class="w-full rounded-lg border-1 border-gray-300" type="date"
                        ...
                        @if ($usahaStatus == 'Dagang' && !$saved)
                        <div>
                            <ul
                                class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex">
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r">
                                    <div class="flex items-center pl-3">
                                        <input wire:model="dagangStatus" id="jual" type="radio" value="Jual"
                                ...
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r">
                                    <div class="flex items-center pl-3">
                                        <input wire:model="dagangStatus" id="beli" type="radio" value="Beli"
                                            name="list-radio" class="w-4 h-4 text-cyan-600 bg-gray-100 border-gray-300">
                                        <label for="beli"
                        ...
                        <div>
                            <label class="block mb-1 text-sm font-medium text-gray-900" for="file_input">Nota</label>
