                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" action="#" method="POST" wire:submit.prevent="{{ $mode }}"
                                ...
                                @if ($showList)
                                    <div class="absolute w-full z-20">
                                        <div class="bg-white p-2 border-2 shadow-lg rounded-lg mt-2">
                                            ...
                                            @if (sizeOf($dropdown) == 0 || (!$dropdown->contains('nama', $search) && $search != ''))
                                                <div
                            ...
                            <div class="relative">
                                <input type="number" id="harga" wire:model.live="harga"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-cyan-600 peer"
                                    placeholder=" " />
                                <label for="harga"
                            ...
                            <div class="relative">
                                <input type="number" id="jumlah" wire:model.live="jumlah"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-cyan-600 peer"
                                    placeholder="{{ $barang ? 'Stok: ' . $barang->stok : ' ' }}" />
                                <label for="jumlah"
