            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form wire:submit.prevent="{{$mode}}" class="">
                        @foreach ($debit as $index=>$debit)
                        <div id="input-box">
                            <div id="input-data" class="flex flex-row pb-4">
                                <div class="basis-1/2 relative pr-2">
                                    <input wire:model.live="search.
                                    
                                    " wire:click="showPerson" wire:click.outside="closePerson" type="text"
                                        id="pengelola.{{ $index }}" name="pengelola.{{ $index }}"
                                    ...
                                    <div class="absolute w-full">
                                        <div class="bg-white p-2 border-2 shadow-lg rounded-lg mt-2">
                                            ...
                                            <div wire:click="setPerson('{{ $item->id_akun }}', '{{ $item->nama }}')"
                                ...
                                <div class="relative basis-1/4 pr-2">
                                    <input wire:model="debit.{{ $index }}" type="text" id="debit" name="debit"
                                        class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-cyan-600 peer"
                                        placeholder=" " />
                                ...
                                <div class="relative basis-1/4 pr-2">
                                    <input wire:model="kredit.{{ $index }}" type="text" id="kredit" name="kredit"
                                        class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-cyan-600 peer"
                                        placeholder=" " />
                                    <label for="kredit"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="pr-2 plusminusbaris">
                                <button type="button"
                                    ...
                                    wire:click.prevent="addRow">Tambah Baris</button>
                                <button type="button"
