<div>
    ...
    <div class="mb-4 flex justify-between">
        {{-- jika button di klik, maka jalankan fungsi dengan tanda add-modal dimana fungsi ini berada pada livewire person.addeditmodal --}}
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                @forelse ($pengelola as $item)
                    {{-- buat livewire untuk masing2 item pengelola number untuk penomoran setiap item, sedangkan person berisi data dari item pengelola --}}
                    @livewire('Person.item', ['number' => $pengelola->firstItem() + $loop->index, 'person' => $item], key(null))
                @empty
                    <tr>
