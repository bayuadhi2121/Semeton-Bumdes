<div>
    ...
    <tr class="bg-white border-b">
        ...
        <td class="px-6 py-4 flex space-x-2">
            {{-- jika button diklik, maka jalankan fungsi dengan tanda edit-modal beserta kirimkan data dengan nama person yang berisikan data $person --}}
            ...
            {{-- sama seperti penjelasan sebelumnya, namun fungsi dengan tanda kali ini berada di livewire person.resetdeletemodal --}}
            <button
