    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                <<<<<<< Updated upstream <button data-drawer-target="sidebar-multi-level-sidebar"
                    ...
                    <a href="{{ route('dashboard') }}" class="flex ml-2 md:mr-24">
                        {{-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3"
                            alt="FlowBite Logo" /> --}}
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">Semeton
                            Bumdes</span>
                    </a>
            </div>
            <div class="flex items-center">
                <div class="flex items-center mr-3">
                    ...
                    <button id="dropdown-user" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover"
                        class="mr-3 text-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center inline-flex items-center"
                        type="button">Selamat Datang, {{ Auth::user()->nama }}</button>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('usaha') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Usaha</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('hutang') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Hutang</a>
                    </li>
                    <li>
                        <a href="{{ route('barang') }}"
